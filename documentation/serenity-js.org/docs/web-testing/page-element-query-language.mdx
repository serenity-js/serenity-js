...
:::info Partially-applied meta-questions
...
This is particularly important in filtering a collection of page elements based on properties of their child-elements, as you'll see in the next section.
:::
