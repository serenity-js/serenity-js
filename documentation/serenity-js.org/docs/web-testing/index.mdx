...
- [**Web-first assertions**](/handbook/web-testing/web-first-assertions) and [**synchronisation**](/handbook/web-testing/waiting-and-synchronisation) - a library of _expectations_ to help you implement web-first assertions, as well as conditional logic and synchronisation using the same consistent pattern.
