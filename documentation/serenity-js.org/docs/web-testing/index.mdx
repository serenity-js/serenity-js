...
[**Serenity/JS web module**](`@serenity-js/web`) is an abstraction layer on top of popular web integration tools like [WebdriverIO](/api/webdriverio), [Playwright](/api/playwrigth), or [Protractor](/api/protractor).
...
- [**Web-first assertions**](/handbook/web-testing/web-first-assertions) and [**synchronisation**](/handbook/web-testing/waiting-and-synchronisation) - a library of _expectations_ to help you implement web-first assertions, as well as conditional logic and synchronisation
