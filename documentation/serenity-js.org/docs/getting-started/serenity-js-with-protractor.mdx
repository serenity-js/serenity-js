...
You can also create aliases for expressions you use frequently:
...
You can also [compose page elements](/handbook/web-testing/page-element-query-language/#composing-page-elements-using-meta-questions) and make them reusable:
...
To retrieve information about the current web page, use [`Page.current()`](/api/web/class/Page/). For example:
...
|----------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| [`element(by.id('...')).getAttribute('class')`](https://www.protractortest.org/#/api?view=webdriver.WebElement.prototype.getAttribute) | [`CssClasses.of(pageElement)`](/api/web/class/CssClasses/)                                            | Serenity/JS returns an array of CSS classes to make assertions easier, instead of a single string |
...
interactions into [tasks](/handbook/design/screenplay-pattern/#tasks) to make them reusable:
