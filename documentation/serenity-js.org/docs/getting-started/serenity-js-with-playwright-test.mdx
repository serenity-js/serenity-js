...
Serenity/JS offers great support for Playwright, including **Playwright Test**, **Playwright Test UI Mode**, **Playwright trace viewer**, and **Playwright auto-waiting locators**!
