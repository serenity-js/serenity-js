...
When you're ready to **start your own test automation project**, use one of the available [**Serenity/JS Project Templates**](/handbook/getting-started#serenityjs-project-templates)
...
and use any of the [Serenity/JS Project Templates](/handbook/getting-started#serenityjs-project-templates) right here in your browser,
