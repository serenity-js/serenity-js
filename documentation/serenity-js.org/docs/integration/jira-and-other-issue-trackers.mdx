...
import ExampleReport from '@site/static/images/integration/jira-and-other-issue-trackers/example-report.png'
import ResultsPerTicketReport from '@site/static/images/integration/jira-and-other-issue-trackers/results-per-ticket-report.png'
```
...
If you need this functionality for any other test runners, please [raise a ticket on GitHub](/serenity-js/serenity-js/issues) or [submit a pull request](/contributing).
:::
...
```bash
npx serenity-bdd run --jiraUrl=https://jira.atlassian.com
```
