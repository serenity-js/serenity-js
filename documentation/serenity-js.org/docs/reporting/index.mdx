...
- [Photographer](/handbook/reporting/photographer) - automatically captures screenshots of the active web browser window, to be archived via [`ArtifactArchiver`](/handbook/reporting/artifact-archiver) and attached to [Serenity BDD reports](/handbook/reporting/serenity-bdd-reporter)
