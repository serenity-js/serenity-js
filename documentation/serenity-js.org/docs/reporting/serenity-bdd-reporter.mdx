...
This reporter emits [`ArtifactGenerated`](/api/core-events/class/ArtifactGenerated) containing Serenity BDD-standard JSON reports,
...
The resulting report contains screenshots, details of HTTP traffic for any [REST API](/api/rest) interactions,
