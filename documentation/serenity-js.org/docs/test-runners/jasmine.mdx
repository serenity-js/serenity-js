...
`jasmine` command line interface directly, for example for **domain-level** or [**REST/HTTP API-level**](handbook/api-testing/)
testing.

If you want your Jasmine scenarios to interact with **web interfaces**, however,
