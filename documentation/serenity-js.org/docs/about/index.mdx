...
- How the [modular architecture](/handbook/about/architecture) of Serenity/JS works and why it's beneficial for test automation frameworks you build on top of it
...
- [What's changed in Serenity/JS v3](/handbook/about/upgrading-to-serenity-js-3) compared to v2
