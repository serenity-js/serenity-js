...
You can add Serenity/JS to your existing Playwright Test project, or [create a new project](https://playwright.dev/docs/intro).
...
<Figure
    ...
    img={require('./serenity-js-3.3.0-playwright-html-report.png')}
/>
...
<Figure
    ...
    img={require('./serenity-js-3.3.0-playwright-ui-mode.png')}
/>
...
<Figure
    ...
    img={require('./serenity-js-3.3.0-playwright-test-trace-viewer.png')}
/>
