...
:::tip Continuous Delivery of features and fixes
[Serenity/JS Continuous Delivery Pipeline](https://github.com/serenity-js/serenity-js/blob/main/.github/workflows/main.yaml) recognises changes you've marked as `feat` or `fix`
and will **release them automatically to npmjs.com** when your pull request **passes the automated tests** and **gets merged to the main branch** by a Serenity/JS maintainer.

The pipeline runs **thousands of package- and integration-level tests** across a number of supported Node.js runtimes, browsers,
...
:::info Your commit messages will be in the changelog
...
If your Pull Request contains multiple commits, and you'd rather have them [squashed before they're merged](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/incorporating-changes-from-a-pull-request/about-pull-request-merges#squash-and-merge-your-commits), please
let us know in the description of your Pull Request and make sure that the **title of your Pull Request follows the commit message standard**, e.g. `feat(console-reporter): improved stats aggregation` or `docs(website): corrected a typo in the handbook`
:::
