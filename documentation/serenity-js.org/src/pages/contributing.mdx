...
Serenity/JS is a safe space where everyone is welcome to contribute, so feel free to ask questions and discuss the ideas you have on the [Serenity/JS Community Chat](https://gitter.im/serenity-js/Lobby) and we'll do our best to help you get started.
...
Serenity/JS offers a variety of ways to contribute. If you'd like help finding a way that works for you, join the [Serenity/JS Community Chat](https://gitter.im/serenity-js/Lobby) and reach out to the [maintainers](https://github.com/orgs/serenity-js/people) there.
...
- helping maintainers on the [Serenity/JS Community Chat](https://badges.gitter.im/serenity-js/Lobby.svg)
...
- `make compile test` - executes the unit tests located under `packages/*/spec`
...
- `make clean verify report site` - same as verify, but additionally generates aggregated test and coverage reports and produces the serenity-js.org website. This is the **full local build** you should run at least once before committing your changes and submitting the pull request.

If you encounter any issues, let us know on the [Serenity/JS Community Chat](https://gitter.im/serenity-js/Lobby) on Gitter.
