...
- [Serenity/JS Handbook](/handbook/getting-started/why-serenity-js) with articles and tutorials helping you to get started with the framework
...
- Provide supplementary information:
    - If you can reproduce and isolate the issue, use one of the [Serenity/JS Quickstart Templates](/handbook/getting-started/quickstart-templates) to create a minimalistic example that demonstrates the problem and attach a link to it to your ticket. While this requires a bit more work on your side, it will help us sort out the problem much quicker.
