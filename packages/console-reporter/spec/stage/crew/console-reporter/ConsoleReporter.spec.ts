...
describe('ConsoleReporter', () => {
    ...
    describe('when the scenario fails with an error', () => {
        ...
        it('prints any steps that were skipped as a result of the failure', () => emitter.emit(`
            ...
            {"type":"TaskFinished","event":{"outcome":{"code":32},"timestamp":"2019-11-14T00:09:59.926Z","value":{"correlationId":"ck2xyihkm0003x86uzfy3yd50","name":"And a step that passes"}}}
            ...
            {"type":"TaskFinished","event":{"outcome":{"code":32},"timestamp":"2019-11-14T00:09:59.927Z","value":{"correlationId":"ck2xyihkn0005x86uky06tl7d","name":"And another step that passes"}}}
        ...
        it('prints the details of the failed assertion', () => emitter.emit(`
            ...
            {"type":"TaskFinished","event":{"outcome":{"code":32},"timestamp":"2019-11-14T01:27:21.151Z","value":{"correlationId":"ck2y19yrj0005hd6uhri1iovg","name":"And a step that passes"}}}
        ...
        it('pinpoints exactly where the failure happened', () => emitter.emit(`
            ...
            {"type":"TaskFinished","event":{"outcome":{"code":32},"timestamp":"2019-11-14T23:27:24.833Z","value":{"correlationId":"ck2zcfkpt0007fa6uer31d05y","name":"And a step that passes"}}}
