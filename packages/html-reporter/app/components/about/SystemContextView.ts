...
export function SystemContextView({ systemContext, onOpenSidebar }: SystemContextViewProps): ReturnType<typeof html> {
    ...
    if (!context) {
        return html`
      <div>
        <${ViewTopbar} title="System Context" onOpenSidebar=${openSidebar} />
