...
export function AboutView({ onOpenSidebar }: AboutViewProps): ReturnType<typeof html> {
    const openSidebar = onOpenSidebar || (() => {});

    return html`
    <div>
      <${ViewTopbar} title="About This Report" onOpenSidebar=${openSidebar} />
      <div class="about-view">
        <div class="card">
          ...
          <section>
            ...
            <p>
              Found a bug or have a suggestion? <a href="https://serenity-js.org/community/contributing/reporting-issues/" target="_blank" class="link-accent">Let us know</a> — we'd love to hear from you.
            </p>
          </section>
        </div>
      </div>
