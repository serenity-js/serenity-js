    ...
    <div class="about-view">
      <div class="card">
        <p style="margin:0 0 var(--space-lg)">
          This report is generated by <a href="https://serenity-js.org" target="_blank" rel="noopener" class="link-accent">Serenity/JS</a>.
        ...
        <section>
          ...
          <div class="stack-md">
            ...
            <div class="panel-bg">
              ...
              <p class="section-text">A machine-readable <a href="summary.json" target="_blank" rel="noopener" class="link-accent">summary.json</a> file is generated alongside the report. It contains the same quality data (outcomes, failure patterns, consistency scores) in a format that CI pipelines, dashboards, and AI tools can consume automatically.</p>
            </div>
          </div>
        </section>
