 ...
 */
export type LinkOptions = DashboardLink | TestsLink | CapabilitiesLink | ErrorsLink | ConsistencyLink | TimelineLink | TagsLink | TestRunsLink | SystemLink | AboutLink;
/**
 ...
 */
export declare function link(options: LinkOptions): string;
/**
 ...
 */
export declare function testsLink(options?: Omit<TestsLink, 'view'>): string;
/**
 ...
 */
export declare function scenarioLink(source: {
    path: string;
    line?: number;
    name?: string;
}, options?: Omit<TestsLink, 'view' | 'path'>): string;
/**
 ...
 */
export declare function capabilityLink(path: string): string;
