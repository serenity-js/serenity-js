...
The [`@serenity-js/protractor`](https://serenity-js.org/modules/protractor/) module is a Screenplay Pattern-style adapter
for the [Protractor framework](https://www.protractortest.org/), and helps with testing Angular, React, Vue
