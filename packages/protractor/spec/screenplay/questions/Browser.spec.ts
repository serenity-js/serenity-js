...
describe('Browser', () => {
    ...
    /** @test {Browser.log} */
    it('returns no entries if the console log is empty', () =>
    ...
    /** @test {Browser.log} */
    it('allows the actor to read the browser log entries', () =>
        actorCalled('Bernie').attemptsTo(
            Navigate.to(pageFromTemplate(`
                <html lang="en">
                    <body>
    ...
    const Trigger = PageElement.locatedById('trigger').describedAs('trigger button');
