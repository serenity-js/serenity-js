...
import { List, Navigate, Target, Text } from '../../../src';
import { pageFromTemplate } from '../../fixtures';
import { UIActors } from '../../UIActors';
import { TargetElements } from '../../../src/screenplay/questions/targets';
...
describe('List', () => {
    ...
    describe('(when no filters are applied)', () => {
        ...
        describe('lets the actor interact with the list of matching elements so that it', () => {
            ...
            const picked = List.of(ShoppingList.Titles);
            ...
            it('picks all the items', () => actorCalled('Peter').attemptsTo(
                ...
                Ensure.that(Text.ofAll(picked.items()), contain('coconut milk')),
            ));
