...
export class WebdriverIONotifier implements StageCrewMember {
    ...
    private onSceneFinishes(finishes: SceneFinishes) {
        ...
        if (this.willBeRetried(finishes.outcome)) {
            ...
            const testResultEvent = this.testResultEventFromFinishes(started, finishes);
    ...
    private testResultEventFromFinishes(started: SceneStarts, finishes: SceneFinishes): testStats {
