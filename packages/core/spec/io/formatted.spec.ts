...
describe ('`formatted` tag function', () => {
    ...
    given(
        ...
        { description: 'an array of params',        actual: formatted `${ [ Promise.resolve(1), q('42') ] }`,   expected: '[ <<Promise>>, <<the meaning of life>> ]'    },
        ...
        { description: 'a promised parameter',      actual: formatted `${ p('something') }`,                    expected: '<<Promise>>'                                },
        ...
        { description: 'a "toStringable" object',   actual: formatted `${ ts('result') }`,                      expected: 'result'                                      },
        { description: 'a function parameter',      actual: formatted `${ SomeAttribute }`,                     expected: 'SomeAttribute'                               },
    ).
