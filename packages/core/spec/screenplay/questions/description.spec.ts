...
import { type Actor, Cast, description, Question, type QuestionAdapter, Serenity } from '../../../src';
...
describe('description', () => {
    ...
    //         { description: 'Question<string>',       value: q('string'),         expectedAnswer: `#actor enters "string"`,      expectedDescription: `#actor enters some value` },
    //         { description: 'Question<number>',       value: q(123),              expectedAnswer: `#actor enters 123`,           expectedDescription: `#actor enters some value` },
    //         { description: 'Question<bigint>',       value: q(BigInt(123)),      expectedAnswer: `#actor enters 123`,           expectedDescription: `#actor enters some value` },
    //         { description: 'Question<boolean>',      value: q(false),            expectedAnswer: `#actor enters false`,         expectedDescription: `#actor enters some value` },
    //         { description: 'Question<undefined>',    value: q(undefined),        expectedAnswer: `#actor enters undefined`,     expectedDescription: `#actor enters some value` },
    //         { description: 'Question<symbol>',       value: q(Symbol('abc')),    expectedAnswer: `#actor enters Symbol(abc)`,   expectedDescription: `#actor enters some value` },
    //         { description: 'Question<null>',         value: q(null),             expectedAnswer: `#actor enters null`,          expectedDescription: `#actor enters some value` },
    //
    //         // Questions resolving to promised primitive values
    //         { description: 'Question<Promise<string>>',       value: q(p('string')),      expectedAnswer: `#actor enters "string"`,      expectedDescription: `#actor enters some value` },
    //         { description: 'Question<Promise<number>>',       value: q(p(123)),           expectedAnswer: `#actor enters 123`,           expectedDescription: `#actor enters some value` },
    //         { description: 'Question<Promise<bigint>>',       value: q(p(BigInt(123))),   expectedAnswer: `#actor enters 123`,           expectedDescription: `#actor enters some value` },
    //         { description: 'Question<Promise<boolean>>',      value: q(p(false)),         expectedAnswer: `#actor enters false`,         expectedDescription: `#actor enters some value` },
    //         { description: 'Question<Promise<undefined>>',    value: q(p(undefined)),     expectedAnswer: `#actor enters undefined`,     expectedDescription: `#actor enters some value` },
    //         { description: 'Question<Promise<symbol>>',       value: q(p(Symbol('abc'))), expectedAnswer: `#actor enters Symbol(abc)`,   expectedDescription: `#actor enters some value` },
    //         { description: 'Question<Promise<null>>',         value: q(p(null)),          expectedAnswer: `#actor enters null`,          expectedDescription: `#actor enters some value` },
    //     ];
    //
    //     given(examples).
    ...
    it('resolves to a value with interpolated parameters', async () => {
        const value = q('some value', 'some description');
        const expectedDescription = `#actor enters some description`;
        const expectedAnswer = `#actor enters "some value"`;

        const question = description`#actor enters ${value}`;

        const actualAnswer = await actor.answer(question);
        const actualDescription = await actor.describe(question);

        expect(actualDescription.value).to.equal(expectedDescription);
    ...
    //         { description: 'Date',                  value: new Date('1995-12-17T03:24:00.000Z'),            expectedAnswer: `#actor enters Date(1995-12-17T03:24:00.000Z)`,                                     expectedDescription: `#actor enters Date(1995-12-17T03:24:00.000Z)`,                                    },
