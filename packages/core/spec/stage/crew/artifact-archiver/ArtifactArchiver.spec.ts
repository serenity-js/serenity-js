...
import type { Actor, StageCrewMember } from '../../../../src';
import { Clock, Duration, ErrorFactory } from '../../../../src';
...
import { ArtifactArchiver, Stage, StageManager } from '../../../../src/stage';
...
describe('ArtifactArchiver', () => {
    ...
    describe('stores the artifacts generated by other stage crew members', () => {
        ...
        beforeEach(() => {
            ...
            stage = new Stage(
                new Extras(),
                new StageManager(Duration.ofMilliseconds(250), clock),
                new ErrorFactory(),
                clock,
                interactionTimeout
            );
    ...
    it('notifies the StageManager when the artifact is correctly archived', () => {
        ...
        const clock = new Clock();
        const stageManager = new StageManager(Duration.ofMilliseconds(250), clock);
