...
describe('isBefore', () => {
    ...
    it('breaks the actor flow when "actual" is not before the "expected" Date', () => {
        return expect(actorCalled('Astrid').attemptsTo(
            ...
            | Expected Date(1995-01-01T00:00:00.000Z) to have value that is before Date(1985-01-01T00:00:00.000Z)
            |
    ...
    it('contributes to a human-readable description', () => {
        expect(Ensure.that(new Date('1985-01-01'), isBefore(new Date('1995-01-01'))).toString())
            .to.equal(`#actor ensures that Date(1985-01-01T00:00:00.000Z) does have value that is before Date(1995-01-01T00:00:00.000Z)`);
    });
});
