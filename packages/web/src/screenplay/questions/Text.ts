...
export class Text {
    ...
    static of(element: Answerable<PageElement>):
        ...
        Model<string>                                                // eslint-disable-line @typescript-eslint/indent
    {
        return createModel<Promise<string>, ElementQuestion<Promise<string>> & MetaQuestion<Answerable<PageElement>, Promise<string>>>(
