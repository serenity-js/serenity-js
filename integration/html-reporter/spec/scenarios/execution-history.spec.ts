...
describe('Test Scenarios', () => {
    ...
    describe('Execution History', () => {
        ...
        it('shows execution history dots for cross-run comparison', { tag: '@showcase' }, async ({ actor, scenariosView, scenarioDetailView }) => {
        ...
        it('shows error details when navigating to a degraded scenario', { tag: '@showcase' }, async ({ actor, consistencyView, scenarioDetailView }) => {
            await actor.attemptsTo(
