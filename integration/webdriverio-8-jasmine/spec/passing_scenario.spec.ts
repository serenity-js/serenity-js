...
import { SceneFinished, SceneStarts, SceneTagged, TestRunFinished, TestRunFinishes, TestRunnerDetected, TestRunStarts } from '@serenity-js/core/events';
import { BrowserTag, CapabilityTag, ExecutionSuccessful, FeatureTag, Name, PlatformTag } from '@serenity-js/core/model';
import { describe, it } from 'mocha';

import { wdio } from '../src';

describe('Serenity/JS with WebdriverIO 8 and Jasmine', function () {
