...
import { SceneStarts, SceneTagged, TestRunFinished, TestRunFinishes, TestRunnerDetected, TestRunStarts } from '@serenity-js/core/events';
import { CapabilityTag, Category, FeatureTag, Name, ThemeTag } from '@serenity-js/core/model';
...
describe('@serenity-js/jasmine', function () {
    ...
    describe('when no describe blocks are used', () => {
        ...
        it('uses file path as feature name', () => jasmine('examples/no-describe-blocks.spec.js')
        ...
        it('uses nested file path as feature name', () => jasmine('examples/nested/another-no-describe-blocks.spec.js')
            .then(ifExitCodeIsOtherThan(0, logOutput))
            .then(result => {
