...
import { ActivityRelatedArtifactGenerated, SceneFinished, SceneStarts } from '@serenity-js/core/events';
import { ExecutionFailedWithAssertionError, ExecutionSuccessful, Name, Photo, ProblemIndication } from '@serenity-js/core/model';
