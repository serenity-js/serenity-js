...
describe('@serenity-js/playwright-test', function () {
    ...
    describe('recognises a failing scenario that', () => {
        ...
        it('throws an error', () => playwrightTest('--grep', 'failing/error-thrown.spec.ts')
        ...
        it('fails because of a failing Playwright assertion', () => playwrightTest('--grep', 'failing/failing-playwright-assertion.spec.ts')
            .then(ifExitCodeIsOtherThan(1, logOutput))
            .then(result => {
        ...
        it('fails with a Serenity/JS AssertionError', () => playwrightTest('--grep', 'failing/failing-serenity-js-assertion.spec.ts')
            .then(ifExitCodeIsOtherThan(1, logOutput))
            .then(result => {
        ...
        it('fails with a Serenity/JS Screenplay AssertionError', () => playwrightTest('--grep', 'failing/failing-serenity-js-screenplay-assertion.spec.ts')
            .then(ifExitCodeIsOtherThan(1, logOutput))
            .then(result => {
        ...
        it('is compromised', () => playwrightTest('--grep', 'failing/test-compromised.spec.ts')
            .then(ifExitCodeIsOtherThan(1, logOutput))
            .then(result => {
        ...
        it('is marked as failing but passes', () => playwrightTest('--grep', 'failing/marked-as-failing-but-passes.spec.ts')
            .then(ifExitCodeIsOtherThan(1, logOutput))
            .then(result => {
