...
import { BrowserTag, ExecutionSuccessful, FeatureTag, Name, PlatformTag } from '@serenity-js/core/model';
import { describe, it } from 'mocha';

import { wdio } from '../src';

describe('Serenity/JS with WebdriverIO and Cucumber', function () {
