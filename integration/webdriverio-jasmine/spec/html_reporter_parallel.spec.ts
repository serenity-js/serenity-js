...
describe('HtmlReporter with parallel WebdriverIO workers', function () {
    ...
    it('produces data.js containing all scenarios from multiple workers', () =>
        wdio(
            ...
            '--spec=examples/parallel_worker_a.spec.js',
            '--spec=examples/parallel_worker_b.spec.js',
        )
        ...
        .then(result => {
            ...
            // All 4 scenarios from both workers should be present
            ...
            expect(reportData.summary.outcomes.error).to.equal(1);
